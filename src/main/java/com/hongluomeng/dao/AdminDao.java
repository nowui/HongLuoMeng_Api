...
public class AdminDao {
	...
	public void save(Admin admin, String user_id) {
		admin.setAdmin_id(Utility.getUUID());
		admin.setAdmin_create_user_id(user_id);
		admin.setAdmin_create_time(new Date());
		admin.setAdmin_update_user_id(user_id);
		admin.setAdmin_update_time(new Date());

		admin.save();
	}

	public void update(Admin admin, String user_id) {
