...
public class SmsService {
	...
	public Integer countBySms_phoneAndSms_codeAndMinute(String sms_phone, String sms_code, Integer minute) {
		return smsDao.countBySms_phoneAndSms_codeAndSms_statusAndMinute(sms_phone, sms_code, false, minute);
	}

	public void save(JSONObject jsonObject, String ip_address) throws ApiException {
		...
		count = smsDao.countBySms_phoneAndMinute(smsMap.getSms_phone(), 1);
	...
	public void updateSms_statusBySms_phone(String sms_phone, String sms_code) {
		smsDao.updateSms_statusBySms_phone(true, sms_phone, sms_code);
	}
