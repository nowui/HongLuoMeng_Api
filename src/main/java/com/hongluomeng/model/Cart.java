...
public class Cart extends Model<Cart> {
	...
	public static final String KEY_SHOP = "cart";
	public static final String KEY_SHOP_ID = "cart_id";
	...
	public static final String KEY_SHOP_CREATE_USER_ID = "cart_create_user_id";
	public static final String KEY_SHOP_CREATE_TIME = "cart_create_time";
	public static final String KEY_SHOP_UPDATE_USER_ID = "cart_update_user_id";
	public static final String KEY_SHOP_UPDATE_TIME = "cart_update_time";
	public static final String KEY_SHOP_STATUS = "cart_status";
	...
	public void setCart_create_user_id(String cart_create_user_id) {
		set(KEY_SHOP_CREATE_USER_ID, cart_create_user_id);
	}

	public void setCart_create_time(Date cart_create_time) {
		set(KEY_SHOP_CREATE_TIME, cart_create_time);
	}

	public void setCart_update_user_id(String cart_update_user_id) {
		set(KEY_SHOP_UPDATE_USER_ID, cart_update_user_id);
	}

	public void setCart_update_time(Date cart_update_time) {
		set(KEY_SHOP_UPDATE_TIME, cart_update_time);
	}
	...
	public void setCart_status(Boolean cart_status) {
		set(KEY_SHOP_STATUS, cart_status);
	}
